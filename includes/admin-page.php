...
<div class="wrap depremrss-admin">
    ...
    <div class="depremrss-content">
        <div class="depremrss-main">
            ...
            <p>
                <code><?php echo esc_url(home_url('/feed/deprem')); ?></code>
                <button type="button" class="button" onclick="navigator.clipboard.writeText('<?php echo esc_js(home_url('/feed/deprem')); ?>')">
